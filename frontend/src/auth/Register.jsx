...
export default function RegisterPage() {
  ...
  const strengthColor = [COLORS.red, COLORS.red, COLORS.amber, COLORS.green, COLORS.green][strength];
    ...
    <div className="min-h-screen w-full flex items-center justify-center px-6 py-12" style={{ backgroundColor: COLORS.bg, color: COLORS.text }}>
      ...
      <div className="w-full max-w-sm" style={{ fontFamily: "'Inter', sans-serif" }}>
        ...
        <form onSubmit={handleSubmit} noValidate className="mt-8 space-y-5">
          {/* Name */}
          <div>
            <label className="block text-xs font-medium mb-1.5" style={{ color: COLORS.muted }}>Full name</label>
            <input
              type="text"
              value={form.name}
            ...
            />
            {errors.name && <p className="mt-1.5 text-xs" style={{ color: COLORS.red }}>{errors.name}</p>}
          </div>
          ...
          {/* Password */}
          <div>
            <label className="block text-xs font-medium mb-1.5" style={{ color: COLORS.muted }}>Password</label>
            ...
            {form.password && (
              <div className="mt-2 flex items-center gap-2">
                <div className="flex-1 h-1 rounded-full overflow-hidden" style={{ backgroundColor: COLORS.border }}>
                  <div
        ...
        <p className="mt-8 text-center text-sm" style={{ color: COLORS.muted }}>
          ...
          <Link to="/sign-in" className="font-medium" style={{ color: COLORS.amber }}>Sign in</Link>
        </p>
      </div>
    </div>
  );
